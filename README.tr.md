...
Bu sürüm `java-rust-dubbo:0.4.1` kullanır. Provider service interface ve payload sözleşmeleri
değişmedi. `rest-sample-dubbo-consumer:0.3.2` ile doğrudan birlikte çalışır.
